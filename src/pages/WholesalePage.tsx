...
function Navbar() {
  ...
  return (
    <div className="absolute left-[48px] top-[32px] h-20 w-[1344px] rounded-2xl bg-[#F9FAFB] shadow-[0px_6px_20px_-2px_rgba(30,37,45,0.10)] outline outline-1 outline-offset-[-1px] outline-[#E0E0E0]">
      <AssetImage
...
function Footer() {
  ...
  return (
    <div className="absolute left-0 top-[5059px] h-96 w-[1440px] overflow-hidden border-t border-[#E0E0E0]">
