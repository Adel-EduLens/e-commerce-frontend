...
export default function RentalShopPage() {
  ...
  const { data: catData } = useCategories("RENTAL");
    ...
    return products.map((product: Product) => {
      ...
      return (
        <ProductCard
          ...
          price={`${product.rentalPrice ?? product.retailPrice ?? product.price ?? 0} EGP`}
