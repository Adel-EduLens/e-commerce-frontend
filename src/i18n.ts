...
import traderRetailCategoriesEn from "./locales/en/traderRetailCategories.json";
import traderRetailCategoriesAr from "./locales/ar/traderRetailCategories.json";

import traderBlankProductsEn from "./locales/en/traderBlankProducts.json";
import traderBlankProductsAr from "./locales/ar/traderBlankProducts.json";
...
import traderShippingEn from "./locales/en/traderShipping.json";
import traderShippingAr from "./locales/ar/traderShipping.json";
...
import traderPrivacyEn from "./locales/en/traderPrivacy.json";
import traderPrivacyAr from "./locales/ar/traderPrivacy.json";
  ...
  .init({
    resources: {
      en: {
        ...
        rentalDetailsPage: retailDetailsEn,
        ...
        traderRentalCategories: traderRetailCategoriesEn,
      ...
      ar: {
        ...
        rentalDetailsPage: retailDetailsAR,
        ...
        traderRentalCategories: traderRetailCategoriesAr,
